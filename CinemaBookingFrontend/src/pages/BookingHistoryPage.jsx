...
async function fetchBookingHistory(page) {
...
function BookingHistoryPage() {
  ...
  const {
    ...
    queryFn: () => fetchBookingHistory(page),
    staleTime: 2 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
  ...
  const handlePayNow = async (booking) => {
    try {
      ...
      alert(err?.response?.data?.message || err.message || "Không thể khởi tạo thanh toán");
    } finally {
      setPayingId("");
    }
  };
  ...
  const handleDownloadQr = async (bookingId, bookingCode) => {
    try {
      const response = await axiosClient.get(`/tickets/download/${bookingId}`, {
        responseType: "blob",
      });
      ...
      alert(err?.response?.data?.message || err.message || "Không thể tải mã QR");
    }
  };
      ...
      <div className="booking-history-container">
        <section className="booking-history-header">
          ...
          <div className="booking-history-summary">
            ...
            <div className="glass-panel">
              <span className="material-symbols-outlined booking-green">
                event_available
              </span>
              <div>
                <p>Vé sắp tới</p>
        ...
        <section className="booking-history-list">
          {loading ? (
            ...
            <div className="booking-empty glass-panel">
              ...
              <h2>Không tải được lịch sử đặt vé</h2>
              <p>
